    ...
    return Container(
      ...
      child: BottomNavigationBar(
        ...
        items: <BottomNavigationBarItem>[
          _buildNavItem(Icons.message, currentIndex == 0),
          _buildNavItem(Icons.group, currentIndex == 1),
          _buildNavItem(Icons.home, currentIndex == 2),
          _buildNavItem(Icons.notifications, currentIndex == 3),
          _buildNavItem(Icons.event_busy, currentIndex == 4),
          _buildNavItem(Icons.event_note_rounded, currentIndex == 5),
          _buildNavItem(Icons.person, currentIndex == 6),
        ],
        onTap: onTap,
